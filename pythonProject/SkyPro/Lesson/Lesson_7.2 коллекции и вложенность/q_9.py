'''9. ⚙️ Фильтрация
9 из 12
Теперь мы предоставим вам структуру данных с высокой вложенностью. Это данные экскурсоводов. Выведите экскурсоводов, у которых количество туров больше или равно 5.
...
for i in guides:
    if i["fields"]["tours_count"] >= 5:
        name = str(i["fields"]["full_name"])
        count_tours = int(i["fields"]["tours_count"])
        print(f'{name} | туров: {count_tours}')